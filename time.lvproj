...
<Project Type="Project" LVVersion="20008000">
	...
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="candidates" Type="Folder">
			...
			<Item Name="Compute New Timeout.vi" Type="VI" URL="../candidates/Compute New Timeout.vi"/>
		</Item>
		...
		<Item Name="tests" Type="Folder">
			<Item Name="TEST - Periodic Trigger.vi" Type="VI" URL="../tests/TEST - Periodic Trigger.vi"/>
			<Item Name="TEST - Tick Count (ms).vi" Type="VI" URL="../tests/TEST - Tick Count (ms).vi"/>
			<Item Name="TEST - Wait (ms).vi" Type="VI" URL="../tests/TEST - Wait (ms).vi"/>
			<Item Name="TEST - Wait Until Next ms Multiple.vi" Type="VI" URL="../tests/TEST - Wait Until Next ms Multiple.vi"/>
		</Item>
